...
describe('Job Management Update Component', () => {
  ...
  describe('ngOnInit', () => {
    it('Should call Task query and add missing value', () => {
      ...
      const tasks: ITask[] = [{ id: 520 }];
      job.tasks = tasks;

      const taskCollection: ITask[] = [{ id: 1427 }];
    ...
    it('Should call Employee query and add missing value', () => {
      const job: IJob = { id: 456 };
      const employee: IEmployee = { id: 17980 };
      job.employee = employee;

      const employeeCollection: IEmployee[] = [{ id: 32217 }];
    ...
    it('Should update editForm', () => {
      const job: IJob = { id: 456 };
      const task: ITask = { id: 19937 };
      job.tasks = [task];
      const employee: IEmployee = { id: 31763 };
      job.employee = employee;
