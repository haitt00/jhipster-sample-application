...
describe('CreditCard Management Update Component', () => {
  ...
  describe('ngOnInit', () => {
    ...
    it('Should update editForm', () => {
      const creditCard: ICreditCard = { id: 456 };
      const cardHolder: ICustomer = { id: 92708 };
      creditCard.cardHolder = cardHolder;

      activatedRoute.data = of({ creditCard });
      comp.ngOnInit();

      expect(comp.customersSharedCollection).toContain(cardHolder);
