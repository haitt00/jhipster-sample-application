...
describe('JobHistory Management Update Component', () => {
  ...
  describe('ngOnInit', () => {
    it('Should call job query and add missing value', () => {
      ...
      const job: IJob = { id: 7618 };
      jobHistory.job = job;

      const jobCollection: IJob[] = [{ id: 17668 }];
    ...
    it('Should call department query and add missing value', () => {
      const jobHistory: IJobHistory = { id: 456 };
      const department: IDepartment = { id: 8340 };
      jobHistory.department = department;

      const departmentCollection: IDepartment[] = [{ id: 13402 }];
    ...
    it('Should call employee query and add missing value', () => {
      const jobHistory: IJobHistory = { id: 456 };
      const employee: IEmployee = { id: 2003 };
      jobHistory.employee = employee;

      const employeeCollection: IEmployee[] = [{ id: 4176 }];
    ...
    it('Should update editForm', () => {
      const jobHistory: IJobHistory = { id: 456 };
      const job: IJob = { id: 30138 };
      jobHistory.job = job;
      const department: IDepartment = { id: 32121 };
      jobHistory.department = department;
      const employee: IEmployee = { id: 3213 };
      jobHistory.employee = employee;
