...
class CustomerResourceIT {
    ...
    public static Customer createEntity(EntityManager em) {
        Customer customer = new Customer().name(DEFAULT_NAME).phone(DEFAULT_PHONE).mail(DEFAULT_MAIL);
        return customer;
    }
    ...
    public static Customer createUpdatedEntity(EntityManager em) {
        Customer customer = new Customer().name(UPDATED_NAME).phone(UPDATED_PHONE).mail(UPDATED_MAIL);
        return customer;
    }
    ...
    void putExistingCustomer() throws Exception {
        ...
        updatedCustomer.name(UPDATED_NAME).phone(UPDATED_PHONE).mail(UPDATED_MAIL);
    ...
    void fullUpdateCustomerWithPatch() throws Exception {
        ...
        partialUpdatedCustomer.name(UPDATED_NAME).phone(UPDATED_PHONE).mail(UPDATED_MAIL);
